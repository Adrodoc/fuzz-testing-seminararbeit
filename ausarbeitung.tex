...
In all diesen einfachen Beispielen erreichte EvoSuite einen Mutationscore von über 65\% bei einer Zweigabdeckung von 100\% (Gemessen mit \texttt{java -jar evosuite-1.0.6.jar -target bin/main -class Fakultaet -projectCP bin/test -seed 0 -measureCoverage -criterion MUTATION:BRANCH}).
